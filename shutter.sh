...
APP=shutter
BIN="$APP"
DEPENDENCES="imagemagick librsvg libwnck3 pango-perl perl-carp-always perl-file-basedir perl-file-copy-recursive perl-file-which perl-glib-object-introspection perl-goocanvas2 perl-goocanvas2-cairotypes perl-gtk3 perl-gtk3-imageview perl-json perl-json-maybexs perl-locale-gettext perl-moo perl-net-dbus perl-number-bytes-human perl-proc-processtable perl-proc-simple perl-readonly perl-sort-naturally perl-www-mechanize perl-x11-protocol perl-xml-simple procps-ng xdg-desktop-portal xdg-utils bc libappindicator-gtk3 perl-image-exiftool perl-lwp-protocol-https perl-net-oauth perl-path-class webp-pixbuf-loader perl glib-perl libgirepository gtk3 gobject-introspection-runtime pango harfbuzz at-spi2-core cairo-perl perl-cairo-gobject perl-xml-twig perl-xml-parser perl-gtk3 perl-http-message perl-glib-object-introspection glib2 glibc libdbusmenu-gtk3 perl-sub-quote perl-encode-locale goocanvas libdbusmenu-glib perl-uri perl-libwww librsvg noto-fonts"
...
test ! -e "$iconfile" && cp .junest/usr/share/icons/hicolor/scalable/apps/shutter.svg ~/.local/share/pixmaps/
...
function _remove_more_bloatwares() {
    ...
    rm -rf ./"$APP".AppDir/.junest/usr/lib64/cmake
...
mv ./Shutter-x86_64.AppImage ./Shutter-"$VERSION"-x86_64.AppImage
